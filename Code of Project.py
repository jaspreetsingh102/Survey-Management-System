...
def OPERATIONS(x):
    ...
    def DATA_READING(x):   
        ...
        if x==1:            
            ...
            print()
            dataframe=pd.read_csv(r"C:\Users\HP\OneDrive\Desktop\project\Informatics Practices Project .csv")           
            print(dataframe)
        else:           
            print("Reading CSV File Without Index :- ")
            print()
            dataframe=pd.read_csv(r"C:\Users\HP\OneDrive\Desktop\project\Informatics Practices Project .csv",index_col=0)           
            print(dataframe)
    def DATA_VISUALIZATION(x):
        print("=> [ Data Visualization Based Operations ] ")
        print()
        DF=pd.read_csv(r"C:\Users\HP\OneDrive\Desktop\project\Informatics Practices Project .csv")
        State=DF["State"]
        #Capital=DF["Capital"]
    ...
    def DATA_MANIPULATION(x):
        print("=> [ Data Manipulation Based Operations ] ")
        print()
        DF=pd.read_csv(r"C:\Users\HP\OneDrive\Desktop\project\Informatics Practices Project .csv",index_col=0)
        if x==6:
            print("Data Sorting")
            print()
